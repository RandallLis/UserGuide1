...
float AnalogValue = 0.0; // Declare "AnalogValue" as a variable with decimals
int AnalogPin = A5; // Declare "Vin" as a variable for pin A5
...
int AnalogValue = analogRead(AnalogPin);  // Identify the state of AnalogPin as the value of AnalogValue 

Vout = AnalogValue * (Vin / 1023); // Convert the AnalogValue to voltage value by dividing by 1023 
